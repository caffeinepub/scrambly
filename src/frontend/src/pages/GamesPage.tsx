...
import { Clock, ExternalLink, Gamepad2, Play, X, Zap } from "lucide-react";
...
const GAMES = [
  {
    ...
    title: "Block Blast",
    description:
      "Drop and blast colorful blocks in this Sonic-themed puzzle game! Clear rows to score big!",
  ...
  },
  {
    ...
    title: "Sonic Runner",
    description:
      "Run at supersonic speed, dodge obstacles, and collect rings in this endless runner!",
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {GAMES.map((game) => (
          <div
            key={game.id}
            className="sonic-card overflow-hidden group hover:shadow-sonic transition-all duration-200"
          >
            <div className="relative">
              ...
              <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between">
                <span
                  className={`text-xs font-nunito font-700 px-2 py-0.5 rounded-full ${game.badgeColor} bg-white/90`}
                >
                  {game.badge}
                </span>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <p className="font-nunito text-xs text-primary-foreground/80">
              Explore more Sonic-compatible games →
            </p>
          </div>
        </div>
        <ExternalLink
          size={20}
          className="text-primary-foreground/80 group-hover:translate-x-1 transition-transform"
        />
      </button>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <p className="font-fredoka text-lg leading-tight text-foreground">
              Coming Soon
            </p>
        ...
        <Zap
          size={20}
          className="text-secondary-foreground/60 group-hover:text-secondary-foreground transition-colors"
        />
      </button>

      {/* Coming Soon Modal */}
      {showComingSoonModal && (
        // biome-ignore lint/a11y/useKeyWithClickEvents: modal backdrop/card, keyboard handled by close button
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm"
          onClick={() => setShowComingSoonModal(false)}
        >
          {/* biome-ignore lint/a11y/useKeyWithClickEvents: stop propagation on modal card, keyboard handled by close button */}
          <div
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-fredoka text-2xl text-foreground">
                Coming Soon!
              </h2>
            </div>
            ...
            <p className="font-nunito text-sm text-muted-foreground">
              Head over to <strong>Settings → Send Your Best Ideas</strong> to
