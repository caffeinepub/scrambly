        ...
        <div className="bg-sonic-blue/20 rounded-2xl p-6 border-2 border-sonic-yellow/30">
          {started && (
            <div className="flex justify-between items-center mb-4">
              <span className="text-white font-nunito">
                Moves: <strong className="text-sonic-yellow">{moves}</strong>
              </span>
              <span className="text-white font-nunito flex items-center gap-1">
                <Clock className="w-4 h-4 text-sonic-yellow" />{" "}
                {formatTime(seconds)}
              </span>
            </div>
          )}
          ...
          {!started ? (
            <div className="text-center py-8">
              ...
              <p className="text-white font-nunito mb-6">
                Flip cards to find matching Sonic character pairs!
              </p>
              <Button
                onClick={initCards}
          ...
          {started && !won && (
            <Button
              onClick={initCards}
              variant="ghost"
              className="w-full mt-4 text-white/40 hover:text-white font-nunito text-sm"
            >
