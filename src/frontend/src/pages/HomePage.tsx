...
import { Gamepad2, Heart, Search, Users, Video } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Your ultimate Sonic the Hedgehog fan hub. Search, watch speedruns,
            play games, and connect with fans!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Find Sonic characters, lore, and more
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Watch Sonic 1, 2, 3 & Mania speedruns
              </p>
            </div>
          </Link>
