  ...
  if (isSupported === false) {
    return (
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <h3 className="text-xl font-fredoka text-foreground">
          Camera Not Supported
        </h3>
  ...
  if (error && error.type === "permission") {
    return (
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="text-muted-foreground font-nunito text-sm leading-relaxed">
          Scrambly needs a quick photo to verify you're a real person. The photo
          is immediately deleted — nothing is stored.
        </p>
    ...
    return (
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <Button
          onClick={handleRetry}
          variant="outline"
          className="w-full rounded-full font-nunito"
        >
          <RefreshCw size={16} className="mr-2" />
          Try Again
        </Button>
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="text-center mb-1">
        <h3 className="text-2xl font-fredoka text-foreground">
          Quick Face Check
        </h3>
        <p className="text-muted-foreground font-nunito text-sm mt-1">
          We need a quick selfie to verify you're a real person. It's deleted
          instantly!
        </p>
      </div>
      ...
      <div className="flex items-start gap-2 bg-muted/60 rounded-xl p-3 w-full">
        ...
        <p className="text-xs font-nunito text-muted-foreground">
          <strong>Privacy protected:</strong> Your photo is captured locally and
          immediately discarded. Nothing is uploaded or stored.
        </p>
      </div>
