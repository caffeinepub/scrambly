...
export default function ParentalFaceScanModal({
  onComplete,
  onSkip,
}: ParentalFaceScanModalProps) {
  ...
  // Cleanup on unmount
  // biome-ignore lint/correctness/useExhaustiveDependencies: stopCamera is a stable ref-based function
  useEffect(() => {
    return () => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
        <div className="bg-card rounded-2xl p-8 max-w-sm w-full mx-4 text-center shadow-2xl border border-border">
          ...
          <p className="text-muted-foreground mb-6">
            Your browser does not support camera access. Please proceed with PIN
            entry.
          </p>
      ...
      <div className="bg-card rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl border border-border">
        ...
        {step === "intro" && (
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
              To access Parental Controls, we need to verify you are a parent.
              Please allow camera access for a quick face scan. Your image is{" "}
              <strong>never stored</strong> and is immediately discarded.
            </p>
        ...
        {step === "verifying" && (
          <div className="text-center py-8">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">
              Verifying parent identity...
            </h2>
            <p className="text-muted-foreground text-sm">
              Your image is being checked and immediately discarded.
            </p>
          </div>
        )}
        ...
        {(step === "error" || error) && (
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              You can still access Parental Controls with your PIN.
            </p>
            <Button onClick={onSkip} className="w-full">
              Skip to PIN Entry
            </Button>
