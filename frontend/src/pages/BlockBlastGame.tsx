...
const ROWS = 10;
const CELL = 48;
const COLORS = ['#1a6fc4', '#f5c800', '#e63946', '#2dc653', '#9b5de5', '#f77f00'];
...
export default function BlockBlastGame() {
  ...
  const [highScore, setHighScore] = useState(() => parseInt(localStorage.getItem('bb_highscore') || '0'));
  ...
  const dropPiece = useCallback(() => {
    ...
    if (isValid(gridRef.current, piece, 0, 1)) {
      ...
      if (!isValid(gridRef.current, next)) {
        ...
        setGameOver(true);
        if (scoreRef.current > parseInt(localStorage.getItem('bb_highscore') || '0')) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start justify-center">
        ...
        <div className="sonic-card p-4 flex flex-col items-center">
          <h2 className="font-fredoka text-2xl text-primary mb-3">Block Blast</h2>
          <div
          ...
          >
            ...
            {!started && !gameOver && (
              <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center gap-4">
                <div className="text-4xl font-fredoka text-white">Block Blast</div>
                <p className="text-white/70 font-nunito text-sm text-center px-4">
                  Use arrow keys or swipe to move. Up/Space to rotate. Down to drop fast!
                </p>
            ...
            {gameOver && (
              <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center gap-4">
                <div className="text-4xl font-fredoka text-destructive">Game Over!</div>
        ...
        <div className="flex flex-col gap-4 w-full lg:w-48">
          ...
          {started && !gameOver && (
            <Button onClick={startGame} variant="outline" className="rounded-full font-nunito font-700 text-sm">
