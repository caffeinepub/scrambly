...
import { speedrunVideos, SPEEDRUN_CATEGORIES, SpeedrunCategory } from "../data/speedrunVideos";
...
export default function VideosPage({ kidMode = false, ageRestricted = false }: VideosPageProps) {
  const [selectedCategory, setSelectedCategory] = useState<SpeedrunCategory | "All">("All");
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-foreground mb-2">🎮 Sonic Speedrun Videos</h1>
          <p className="text-muted-foreground text-lg">
            Watch the fastest Sonic speedruns from Sonic 1, 2, 3 & Knuckles, and Sonic Mania!
          </p>
        </div>
        ...
        {filteredVideos.length === 0 ? (
          <div className="text-center py-16">
            <p className="text-muted-foreground text-xl">No videos found for this category.</p>
          </div>
        ) : (
                ...
                <div className="p-4">
                  ...
                  <span
                    className={`inline-block px-3 py-1 rounded-full text-xs font-medium text-white ${
                      categoryColors[video.category as SpeedrunCategory] || "bg-gray-500"
                    }`}
                  >
                    {video.category}
                  </span>
