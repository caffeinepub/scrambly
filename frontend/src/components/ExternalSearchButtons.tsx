 ...
 */
export default function ExternalSearchButtons({ query }: ExternalSearchButtonsProps) {
  ...
  const handleDuckDuckGo = () => {
    playLaugh();
    window.open(`https://duckduckgo.com/?q=${encodedQuery}`, '_blank', 'noopener,noreferrer');
  };
  ...
  return (
    <div className="mt-6">
      <p className="text-xs font-nunito text-muted-foreground mb-3 flex items-center gap-1.5">
        ...
        <span>
          Can't find it in Scrambly? Try searching the web — but beware, Dr. Eggman is watching!
        </span>
      </p>
...
function DuckDuckGoIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true" fill="none">
      ...
      <path d="M9 12.5 Q12 14.5 15 12.5" stroke="#DE5833" strokeWidth="1.2" strokeLinecap="round" fill="none" />
