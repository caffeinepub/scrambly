      ...
      <AlertDialogContent className="rounded-2xl">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="font-nunito text-base">
            Are you sure you want to call <strong>emergency services (911)</strong>?
            Only use this in a real emergency.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel className="rounded-full font-nunito font-700">Cancel</AlertDialogCancel>
          <AlertDialogAction
            onClick={handleCall}
